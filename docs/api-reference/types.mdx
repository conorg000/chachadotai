...
description: 'TypeScript types and data contracts for SafetyLayer SDK'
---

## Overview

SafetyLayer uses types from the `@safetylayer/contracts` package, which defines the API contracts between the SDK and backend.
...
<CardGroup cols={2}>
  ...
  <Card
    ...
    icon="file-contract"
    href="https://github.com/safetylayer/safetylayer/tree/main/packages/contracts"
  >
