...
description: 'Integrate SafetyLayer SDK into your application'
---

## Overview

This guide shows how to integrate the SafetyLayer SDK into different application architectures.

<Note>
  Make sure the [backend is running](/guides/backend-integration) before integrating the SDK.
</Note>
...
// Attach SafetyLayer client to request
